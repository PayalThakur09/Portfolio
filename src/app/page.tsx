            ...
            <div className="row portfolio-container"  data-aos-delay="100">
              ...
              <div className="col-lg-4 col-md-6 portfolio-item filter-web">
                <div className="portfolio-wrap">
                  ...
                  <div className="portfolio-links">
                    <a href="assets/img/portfolio/project1-1.jpg" data-gallery="portfolioGallery" className="portfolio-lightbox" title="Web 3"><i className="bx bx-plus"></i></a>
              ...
              <div className="col-lg-4 col-md-6 portfolio-item filter-app">
                <div className="portfolio-wrap">
                  ...
                  <div className="portfolio-links">
                    <a href="assets/img/portfolio/project5.jpg" data-gallery="portfolioGallery" className="portfolio-lightbox" title="Web 3"><i className="bx bx-plus"></i></a>
                    <a href="portfolio-details.html" title="More Details"><i className="bx bx-link"></i></a>
                  </div>
                </div>
              </div>
              ...
              <div className="col-lg-4 col-md-6 portfolio-item filter-app">
                <div className="portfolio-wrap">
                  ...
                  <div className="portfolio-links">
                    <a href="assets/img/portfolio/project3.jpg" data-gallery="portfolioGallery" className="portfolio-lightbox" title="app 2"><i className="bx bx-plus"></i></a>
                    <a href="portfolio-details.html" title="More Details"><i className="bx bx-link"></i></a>
                  </div>
                </div>
              </div>
              ...
              <div className="col-lg-4 col-md-6 portfolio-item filter-game">
                <div className="portfolio-wrap">
                  ...
                  <div className="portfolio-links">
                    <a href="assets/img/portfolio/project2-1.jpg" data-gallery="portfolioGallery" className="portfolio-lightbox" title="game 2"><i className="bx bx-plus"></i></a>
                    <a href="portfolio-details.html" title="More Details"><i className="bx bx-link"></i></a>
                  </div>
                </div>
              </div>
